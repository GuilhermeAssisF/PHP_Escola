<?php $pageTitle = 'Alunos — Sistema Escolar'; ?>
    ...
    <div class="card">
        ...
        <form method="POST" action="index.php?page=alunos">
            ...
            <div class="btn-group">
                ...
                <?php if ($editData): ?>
                    <a href="index.php?page=alunos" class="btn btn-danger">Cancelar</a>
                <?php endif; ?>
            </div>
        </form>
    </div>
                ...
                <table>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="actions">
                                <a href="index.php?page=alunos&edit=<?= $a['id'] ?>" class="btn btn-primary btn-sm">✏️ Editar</a>
                                <form method="POST" action="index.php?page=alunos" style="display:inline" onsubmit="return confirm('Deseja excluir este aluno?')">
